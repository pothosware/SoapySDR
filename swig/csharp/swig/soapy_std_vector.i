 ...
 * soapy_std_vector.i
 *
 * This is SWIG's std_vector.i with a single change: the setter for Capacity needs to explicitly cast
 * the type of size() to an int because our custom size_t typedef changes size_t to a ulong on 64-bit
 * platforms, and C# doesn't support comparison between int and ulong.
 *
 * -----------------------------------------------------------------------------
 *
 ...
 * T is a primitive type or a pointer. If T does define an operator==, then use the SOAPY_SWIG_STD_VECTOR_ENHANCED
 * macro to obtain this enhanced functionality, for example:
 *
 *   SOAPY_SWIG_STD_VECTOR_ENHANCED(SomeNamespace::Klass)
...
%define SOAPY_SWIG_STD_VECTOR_EXTRA_OP_EQUALS_EQUALS(CTYPE...)
    %extend {
...
%define SOAPY_SWIG_STD_VECTOR_ENHANCED(CTYPE...)
namespace std {
  template<> class vector< CTYPE > {
    SOAPY_SWIG_STD_VECTOR_MINIMUM_INTERNAL(IList, const value_type&, %arg(CTYPE))
    SOAPY_SWIG_STD_VECTOR_EXTRA_OP_EQUALS_EQUALS(CTYPE)
  };
}
%enddef

// Legacy macros
%define SOAPY_SWIG_STD_VECTOR_SPECIALIZE(CSTYPE, CTYPE...)
#warning SOAPY_SWIG_STD_VECTOR_SPECIALIZE macro deprecated, please see csharp/std_vector.i and switch to SOAPY_SWIG_STD_VECTOR_ENHANCED
SOAPY_SWIG_STD_VECTOR_ENHANCED(CTYPE)
%enddef

%define SOAPY_SWIG_STD_VECTOR_SPECIALIZE_MINIMUM(CSTYPE, CTYPE...)
#warning SOAPY_SWIG_STD_VECTOR_SPECIALIZE_MINIMUM macro deprecated, it is no longer required
%enddef
...
namespace std {
  ...
  template<class T> class vector {
    SOAPY_SWIG_STD_VECTOR_MINIMUM_INTERNAL(IEnumerable, const value_type&, T)
  };
  // specialization for pointers
  template<class T> class vector<T *> {
    SOAPY_SWIG_STD_VECTOR_MINIMUM_INTERNAL(IList, const value_type&, T *)
    SOAPY_SWIG_STD_VECTOR_EXTRA_OP_EQUALS_EQUALS(T *)
  };
  // bool is specialized in the C++ standard - const_reference in particular
  template<> class vector<bool> {
    SOAPY_SWIG_STD_VECTOR_MINIMUM_INTERNAL(IList, bool, bool)
    SOAPY_SWIG_STD_VECTOR_EXTRA_OP_EQUALS_EQUALS(bool)
  };
}

// template specializations for std::vector
// these provide extra collections methods as operator== is defined
SOAPY_SWIG_STD_VECTOR_ENHANCED(char)
SOAPY_SWIG_STD_VECTOR_ENHANCED(signed char)
SOAPY_SWIG_STD_VECTOR_ENHANCED(unsigned char)
SOAPY_SWIG_STD_VECTOR_ENHANCED(short)
SOAPY_SWIG_STD_VECTOR_ENHANCED(unsigned short)
SOAPY_SWIG_STD_VECTOR_ENHANCED(int)
SOAPY_SWIG_STD_VECTOR_ENHANCED(unsigned int)
SOAPY_SWIG_STD_VECTOR_ENHANCED(long)
SOAPY_SWIG_STD_VECTOR_ENHANCED(unsigned long)
SOAPY_SWIG_STD_VECTOR_ENHANCED(long long)
SOAPY_SWIG_STD_VECTOR_ENHANCED(unsigned long long)
SOAPY_SWIG_STD_VECTOR_ENHANCED(float)
SOAPY_SWIG_STD_VECTOR_ENHANCED(double)
SOAPY_SWIG_STD_VECTOR_ENHANCED(std::string) // also requires a %include <std_string.i>
SOAPY_SWIG_STD_VECTOR_ENHANCED(std::wstring) // also requires a %include <std_wstring.i>
